                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <div class="rounded badge-unread d-sm-flex border-0 mb-1 p-3 position-relative">
                                ...
                                <!-- Info -->
                                <div class="mx-sm-3 my-2 my-sm-0">
                                    <a class="small text-body stretched-link" href="#!"> Webestica has 15 like and 1 new
                                        activity</a>
                                </div>
                                <!-- Action -->
                                <div class="d-flex ms-auto">
                                    ...
                                    <div class="dropdown position-absolute end-0 top-0 mt-3 me-3">
                                        <a href="#" class="z-index-1 text-secondary btn position-relative py-0 px-2"
                                           id="cardNotiAction3" data-bs-toggle="dropdown" aria-expanded="false">
                                            <i class="bi bi-three-dots"></i>
                                        </a>
                                        <!-- Card share action dropdown menu -->
                        ...
                        <li>
                            <div class="rounded badge-unread d-sm-flex border-0 mb-1 p-3 position-relative">
                                ...
                                <!-- Info -->
                                <div class="mx-sm-3 my-2 my-sm-0">
                                    <a class="stretched-link small text-body" href="#!"><b>Bootstrap in the news:</b>
                                        The search giant’s parent company, Alphabet, just joined an exclusive club of
                                        tech stocks.</a>
                                </div>
                                <!-- Action -->
                                <div class="d-flex ms-auto">
                                    ...
                                    <div class="dropdown position-absolute end-0 top-0 mt-3 me-3">
                                        <a href="#" class="z-index-1 text-secondary btn position-relative py-0 px-2"
                                           id="cardNotiAction5" data-bs-toggle="dropdown" aria-expanded="false">
                                            <i class="bi bi-three-dots"></i>
                                        </a>
                                        <!-- Card share action dropdown menu -->
                        ...
                        <li>
                            <div class="rounded badge-unread d-sm-flex border-0 mb-1 p-3 position-relative">
                                ...
                                <div class="mx-sm-3 my-2 my-sm-0">
                                    ...
                                    <p class="small"><a href="@!"> @Samuel Bishop</a> joined project Blogzine blog theme
                                    </p>
                                </div>
                                <!-- Action -->
                                <div class="d-flex ms-auto">
                        ...
                        <li>
                            <div class="rounded d-sm-flex border-0 mb-1 p-3 position-relative">
                                ...
                                <!-- Info -->
                                <div class="mx-sm-3 my-2 my-sm-0">
                                    <a href="#!" class="stretched-link small mb-0 text-secondary"><b>You have a
                                            Payout!</b> </a>
                                ...
                                <div class="d-flex ms-auto">
                                    ...
                                    <div class="dropdown position-absolute end-0 top-0 mt-3 me-3">
                                        <a href="#" class="z-index-1 text-secondary btn position-relative py-0 px-2"
                                           id="cardNotiAction7" data-bs-toggle="dropdown" aria-expanded="false">
                                            <i class="bi bi-three-dots"></i>
                                        </a>
                                        <!-- Card share action dropdown menu -->
                        ...
                        <li>
                            <div class="rounded d-sm-flex border-0 mb-1 p-3 position-relative">
                                <!-- Avatar -->
                                <div class="avatar text-center">
                                    <img class="avatar-img rounded-circle" src="/images/logo/08.svg" alt="">
                                </div>
                                <!-- Info -->
                                <div class="mx-sm-3 my-2 my-sm-0">
                        ...
                        <li>
                            <div class="rounded d-sm-flex border-0 mb-1 p-3 position-relative">
                                ...
                                <!-- Info -->
                                <div class="mx-sm-3 my-2 my-sm-0">
                                    <p class="small m-0">Congratulate <b>Joan Wallace</b> for graduating from <b>Microverse
                                            university</b></p>
                                    <p class="small mb-0">Order #23685 belonging to Amanda Reed has been cancelled</p>
                                ...
                                <div class="d-flex ms-auto">
                                    ...
                                    <div class="dropdown position-absolute end-0 top-0 mt-3 me-3">
                                        <a href="#" class="z-index-1 text-secondary btn position-relative py-0 px-2"
                                           id="cardNotiAction9" data-bs-toggle="dropdown" aria-expanded="false">
                                            <i class="bi bi-three-dots"></i>
                                        </a>
                                        <!-- Card share action dropdown menu -->
