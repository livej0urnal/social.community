            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <div class="nav mt-3 mt-lg-0 flex-nowrap align-items-center px-4 px-lg-0">
                    <div class="nav-item w-100">
                        <form class="rounded position-relative" method="get" action="<?= \yii\helpers\Url::to(['activity/search']) ?>">
                            <input name="q" <?php if(strlen($_REQUEST['q']) > 1) : ?> value="<?php echo $_REQUEST['q'] ;?>" <?php endif; ?> class="form-control ps-5 bg-light" type="search" placeholder="Search..." aria-label="Search" required>
